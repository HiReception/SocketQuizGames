...
export default class QuestionDisplay extends Component {
	...
	render = () => {
		...
		const { question, fullAnswerRevealed, questionVisible, numAnswersVisible, correctFlashOn, lockedInAnswer } = this.props;
		...
		const answers = question.options.map((a) => {
			return {
				...
				lockedInLit: lockedInAnswer == a.key && (!question.correctResponse.includes(a.key) || !correctFlashOn),
			};
		});
		...
		var winSashHeight = row3Start + aHeight - qHeight;
		...
		return (
			<Layer>
				...
				<Lozenge xStart={0} yStart={row2Start} height={aHeight} width={aWidth} leftSideWidth={sideWidth} rightSideWidth={aGapWidth + 1}
					fillStyle={answers[0].correctLit ? "#00ff00" : (answers[0].lockedInLit ? "orange" : "black")}
					strokeStyle={gradient} lineWidth={lineWidth}/>
				...
				<Lozenge xStart={width - (sideWidth + aWidth)} yStart={row2Start} height={aHeight} width={aWidth} leftSideWidth={0} rightSideWidth={sideWidth}
					fillStyle={answers[1].correctLit ? "#00ff00" : (answers[1].lockedInLit ? "orange" : "black")}
					strokeStyle={gradient} lineWidth={lineWidth}/>

				<Lozenge xStart={0} yStart={row3Start} height={aHeight} width={aWidth} leftSideWidth={sideWidth} rightSideWidth={aGapWidth + 1}
					fillStyle={answers[2].correctLit ? "#00ff00" : (answers[2].lockedInLit ? "orange" : "black")}
					strokeStyle={gradient} lineWidth={lineWidth}/>
				...
				<Lozenge xStart={width - (sideWidth + aWidth)} yStart={row3Start} height={aHeight} width={aWidth} leftSideWidth={0} rightSideWidth={sideWidth}
					fillStyle={answers[3].correctLit ? "#00ff00" : (answers[3].lockedInLit ? "orange" : "black")}
					strokeStyle={gradient} lineWidth={lineWidth}/>
				...
				<Rect
					...
					width={aHeight/5} height={aHeight/5} visible={numAnswersVisible > 0}
					fill={answers[0].correctLit || answers[0].lockedInLit ? "black" : "orange"} rotation="-45"/>
				<Text
					x={sideWidth + aTextGapWidth} y={row2Start + aTextGapHeight}
					width={aLetterWidth} height={aTextHeight} visible={numAnswersVisible > 0}
					fontSize={aTextHeight} fontFamily={fontFamily}
					fill={answers[0].correctLit || answers[0].lockedInLit ? "black" : "orange"} align='left' text={answers[0].key + ":"}/>
				<Text
					x={sideWidth + aTextGapWidth + aLetterWidth} y={row2Start + aTextGapHeight}
					height={aTextHeight} visible={numAnswersVisible > 0}
					fontSize={aTextHeight} fontFamily={fontFamily}
					fill={answers[0].correctLit || answers[0].lockedInLit ? "black" : "white"} align='left'
				...
				<Rect
					...
					width={aHeight/5} height={aHeight/5} visible={numAnswersVisible > 1}
					fill={answers[1].correctLit || answers[1].lockedInLit ? "black" : "orange"} rotation="-45"/>
				<Text
					x={(width+aGapWidth)/2 + aTextGapWidth} y={row2Start + aTextGapHeight}
					width={aLetterWidth} height={aTextHeight} visible={numAnswersVisible > 1}
					fontSize={aTextHeight} fontFamily={fontFamily}
					fill={answers[1].correctLit || answers[1].lockedInLit ? "black" : "orange"} align='left' text={answers[1].key + ":"}/>
				<Text
					x={(width+aGapWidth)/2 + aTextGapWidth + aLetterWidth} y={row2Start + aTextGapHeight}
					height={aTextHeight} visible={numAnswersVisible > 1}
					fontSize={aTextHeight} fontFamily={fontFamily}
					fill={answers[1].correctLit || answers[1].lockedInLit ? "black" : "white"} align='left'
				...
				<Rect
					...
					width={aHeight/5} height={aHeight/5} visible={numAnswersVisible > 2}
					fill={answers[2].correctLit || answers[2].lockedInLit ? "black" : "orange"} rotation="-45"/>
				<Text
					x={sideWidth + aTextGapWidth} y={row3Start + aTextGapHeight}
					width={aLetterWidth} height={aTextHeight} visible={numAnswersVisible > 2}
					fontSize={aTextHeight} fontFamily={fontFamily}
					fill={answers[2].correctLit || answers[2].lockedInLit ? "black" : "orange"} align='left' text={answers[2].key + ":"}/>
				<Text
					x={sideWidth + aTextGapWidth + aLetterWidth} y={row3Start + aTextGapHeight}
					height={aTextHeight} visible={numAnswersVisible > 2}
					fontSize={aTextHeight} fontFamily={fontFamily}
					fill={answers[2].correctLit || answers[2].lockedInLit ? "black" : "white"} align='left'
				...
				<Rect
					...
					width={aHeight/5} height={aHeight/5} visible={numAnswersVisible > 3}
					fill={answers[3].correctLit || answers[3].lockedInLit ? "black" : "orange"} rotation="-45"/>
				<Text
					x={(width+aGapWidth)/2 + aTextGapWidth} y={row3Start + aTextGapHeight}
					width={aLetterWidth} height={aTextHeight} visible={numAnswersVisible > 3}
					fontSize={aTextHeight} fontFamily={fontFamily}
					fill={answers[3].correctLit || answers[3].lockedInLit ? "black" : "orange"} align='left' text={answers[3].key + ":"}/>
				<Text
					x={(width+aGapWidth)/2 + aTextGapWidth + aLetterWidth} y={row3Start + aTextGapHeight}
					height={aTextHeight} visible={numAnswersVisible > 3}
					fontSize={aTextHeight} fontFamily={fontFamily}
					fill={answers[3].correctLit || answers[3].lockedInLit ? "black" : "white"} align='left'
...
QuestionDisplay.propTypes = {
	...
	numAnswersVisible: PropTypes.number,
	correctFlashOn: PropTypes.bool,
	lockedInAnswer: PropTypes.string
};